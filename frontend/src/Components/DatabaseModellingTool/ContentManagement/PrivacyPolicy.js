        ...
        <React.Fragment>
            <div>
                <ReactModal
                    ...
                    onRequestClose={closePrivacyPopUp}
                    ariaHideApp={false}
                >
                    ...
                    <p>Zusätzlich zu den Datenschutzregelungen der Datenschutz-Grundverordnung gelten nationale
                        ...
                        zum Widerspruchsrecht, zur Verarbeitung besonderer Kategorien personenbezogener Daten, zur
                    ...
                    <p><strong>Hinweise zur Einwilligung: </strong>Wir setzen Cookies im Einklang mit den gesetzlichen
                        ...
                        (also unser Onlineangebot) zur Verfügung zu stellen. Die widerrufliche Einwilligung wird
                    ...
                    <p><strong>Allgemeine Hinweise zum Widerruf und Widerspruch (Opt-Out): </strong>Nutzer können die
                        ...
                        zum Widerspruch erfolgen im Rahmen dieser Datenschutzerklärung). Nutzer können Ihren Widerspruch
                        auch mittels der Einstellungen Ihres Browsers erklären.</p>
                    ...
                    <p>Die Beantwortung der Kontaktanfragen sowie die Verwaltung von Kontakt- und Anfragedaten im Rahmen
                        von vertraglichen oder vorvertraglichen Beziehungen erfolgt zur Erfüllung unserer vertraglichen
                    ...
                    <ul className="m-elements">
                        <li><strong>Kontaktformular: </strong>Wenn Nutzer über unser Kontaktformular, E-Mail oder andere
                            ...
                            mitgeteilten Daten zur Bearbeitung des mitgeteilten Anliegens. Zu diesem Zweck verarbeiten
            ...
            <img src={privacyPolicyIcon} className="privacyPolicy" onClick={showPrivacyPopUp} alt="Download"/>
        </React.Fragment>
    );
}
